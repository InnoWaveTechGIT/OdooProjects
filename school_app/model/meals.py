...
class EventsSchoolApp(models.Model):
    ...
    def _compute_image_url1(self):
        ...
        for obj in self:
            if obj.image_1:
                obj.image_1_url= base_url + '/web/image?' + 'model=meals.school.app&id=' + str(obj.id) + '&field=image_1'
            else:
                obj.image_1_url=''
    ...
    def _compute_image_url2(self):
        ...
        for obj in self:
            if obj.image_2:
                obj.image_2_url= base_url + '/web/image?' + 'model=meals.school.app&id=' + str(obj.id) + '&field=image_2'
            else:
                obj.image_2_url=''
    @api.depends('image_3')
    def _compute_image_url3(self):
        ...
        for obj in self:
            if obj.image_3:
                obj.image_3_url= base_url + '/web/image?' + 'model=meals.school.app&id=' + str(obj.id) + '&field=image_3'
            else:
                obj.image_3_url=''